...
改动认证流程、请求字段、参数优先级、响应判定或连接状态时，还必须同步更新 [`docs/development-guide.md` 的“登录原理与调用链”](docs/development-guide.md#73-登录原理与调用链)；若安全边界发生变化，同时更新 README 和 SECURITY.md。文档中只使用明显虚构的账号与网络值，不复制真实门户正文或抓包 URL。
